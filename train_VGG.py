    ...
    for opt_name in optimizers:
        for activation_name in activation_functions:
            ...
            model = tf.keras.models.Sequential([
                tf.keras.layers.Conv2D(64, (3, 3), activation='relu', input_shape=(INPUT_SIZE, INPUT_SIZE, 3), padding='same', kernel_initializer='he_normal'),
            ...
            model_checkpoint = tf.keras.callbacks.ModelCheckpoint(
                './models/VGG.keras',  # 모델 저장 경로, model 이름으로
                monitor='val_accuracy',
